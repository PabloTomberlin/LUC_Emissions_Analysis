...
```
Please download all data to the same location as .rmd file
...
Calculate uncertainty due to LUC emissions revisions
```{r}
...
Visualization for differences in temperatures (relative graph showing deviation from average temperature projection)
```{r}
...
Soil and vegetation carbon plots to determine causes of long-lasting LUC effects.
```{r}
soil_veg <- results_df %>%
